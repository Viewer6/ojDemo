...
GRANT ALL PRIVILEGES ON oj_nacos_local.* TO 'ojtest'@'%';
...
CREATE TABLE IF NOT EXISTS `config_info_aggr` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='聚合配置表';
...
CREATE TABLE IF NOT EXISTS `config_info_beta` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='beta配置表';
...
CREATE TABLE IF NOT EXISTS `config_info_tag` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='配置标签表';
...
/******************************************/
/*   表名称 = users / roles / permissions  权限体系 */
/******************************************/
