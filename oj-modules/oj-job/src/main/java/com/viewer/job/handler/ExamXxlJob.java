package com.viewer.job.handler;
...
import com.viewer.job.domain.exam.Exam;
import com.viewer.job.domain.message.Message;
import com.viewer.job.domain.message.MessageText;
import com.viewer.job.domain.message.vo.MessageTextVO;
import com.viewer.job.domain.user.UserScore;
import com.viewer.job.mapper.exam.ExamMapper;
import com.viewer.job.mapper.message.MessageTextMapper;
import com.viewer.job.mapper.user.UserExamMapper;
import com.viewer.job.mapper.user.UserSubmitMapper;
import com.viewer.job.service.IMessageService;
import com.viewer.job.service.IMessageTextService;
